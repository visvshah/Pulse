...
const prompt2 = `. Your goal is to make it engaging and informative. Ensure the script is easy to understand and has a good flow. Make each script short, being around 4-5 sentences. Do not include any narration or stage directions. Do not include emojis, hashtags, or the name TikTok in your script.
